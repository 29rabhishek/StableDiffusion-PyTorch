...
class Unet(nn.Module):
    ...
    def __init__(self, im_channels, model_config):
        ...
        if self.condition_config is not None:
            ...
            #     self.eeg_cond = True
            #     self.embed_dim = self.condition_config['eeg_condition_config']['text_embed_dim']

            if 'eeg' in condition_types:
                # validate_text_config(self.condition_config)
                self.eeg_cond = True
                self.embed_dim = self.condition_config['eeg_condition_config']['eeg_embed_dim']
        ...
        self.cond = self.eeg_cond or self.image_cond or self.class_cond
        ###################################
    ...
    def forward(self, x, t, cond_input=None):
        ...
        if self.eeg_cond:
            assert 'eeg' in cond_input, \
                "Model initialized with eeg conditioning but cond_input has no eeg information"
            context_hidden_states = cond_input['eeg']
        down_outs = []
